    ...
    <body>
        ...
        <div class="container-fluid w-100 p-0 m-0">
            ...
            <div class="row w-100 p-0 m-0">
                ...
                <!-- Column with Mark's quote which is vertically and horizontally centered. -->
                ...
                <div class="col">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <img src="/storage/img/Memorial001-480x360.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="/storage/img/Memorial002-480x360.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="/storage/img/Memorial005-480x360.jpg" class="d-block w-100" alt="...">
                            </div>
                        </div>
            ...
            <div class="row w-100 p-0 m-0">
                ...
                <div class="col">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                <img src="/storage/img/Memorial003-480x640.jpg" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                <img src="/storage/img/Memorial004-480x640.jpg" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                <img src="/storage/img/Memorial006-480x640.jpg" class="d-block w-100" alt="...">
                                </div>
                            </div>
                            <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
