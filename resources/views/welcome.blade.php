...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            <!-- N5555555555555555555555555avbar (sit on top) -->
    <div class="w3-top">
    ...
    <div class="w3-display-middle w3-margin-top w3-center">
        <h1 class="w3-xxxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>H.I.R.E</b></span> <span class="w3-hide-small w3-text-yellow">Initiative</5pan></h1>
    </div>
    </header>
